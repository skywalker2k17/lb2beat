...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Language bar — below navbar, mobile only */}
      <div style={{
        ...
        padding: "6px 20px",
      }} className="lb-lang-bar">
        <LocaleSwitcher />
      </div>

      <style>{`
        .lb-lang-bar { display: none; }
        @media(max-width:768px){ .lb-lang-bar { display: flex !important; } }
      `}</style>
    </>
  );
}
